...
group = "top.colorgarden.vnccraft"
version = "1.0.0-SNAPSHOT"
description = "VNC remote desktop viewer plugin"

java {
  // Configure the java toolchain. This allows gradle to auto-provision JDK 25 on systems that only have JDK 17 installed for example.
...
bukkitPluginYaml {
  main = "top.colorgarden.vnccraft.plugin.VNCPlugin"
  load = BukkitPluginYaml.PluginLoadOrder.STARTUP
  authors.add("colorgarden")
  apiVersion = "26.1.2"
  commands {
    register("vnc") {
      description = "VNC screen management"
      permission = "vnccraft.admin"
    }
  }
  permissions {
    register("vnccraft.admin") {
      description = "Allows VNC admin commands"
    }
  }
}
